...
public:
	...
	void on_collide()
	{
		...
		{
		case 0:
			mciSendString(_T("play pea_break_1 form 0"), NULL, 0, NULL);
			break;
		case 1:
			mciSendString(_T("play pea_break_2 form 0"), NULL, 0, NULL);
			break;
		case 2:
			mciSendString(_T("play pea_break_3 form 0"), NULL, 0, NULL);
			break;
		}
	}
