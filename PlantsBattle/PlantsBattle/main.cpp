...
IMAGE img_gravestone_left; // 朝向左墓碑图片
IMAGE img_gravestone_right; // 朝向右墓碑图片
IMAGE img_selector_tip; // 选角节目提示信息文字图片
...
Atlas atlas_peashooter_idle_left; // 豌豆射手向左的默认动画图集
Atlas atlas_peashooter_idle_right; // 豌豆射手向右的默认动画图集
Atlas atlas_peashooter_run_left; // 豌豆射手向左的奔跑动画图集
Atlas atlas_peashooter_run_right; // 豌豆射手向右的奔跑动画图集
Atlas atlas_peashooter_attack_ex_left; // 豌豆射手向左的特殊攻击动画图集
Atlas atlas_peashooter_attack_ex_right; // 豌豆射手向右的特殊攻击动画图集
Atlas atlas_peashooter_die_left; // 豌豆射手向左的死亡动画图集
Atlas atlas_peashooter_die_right; // 豌豆射手向右的死亡动画图集
...
Atlas atlas_sunflower_die_left; // 向日葵向左的死亡动画图集
Atlas atlas_sunflower_die_right; // 向日葵向右的死亡动画图集
